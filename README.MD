...
## Queue  
    Automatically synchronizing the most recently edited README.MD with the local README.MD, the committed README.MD, and the README.MD on GitHub. Almost done. Attempting to merge with Git-Repocreater2.bash. Testing.
