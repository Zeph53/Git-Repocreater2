...
## Updates  
    ...
    Improved repository description generation.
...
## Queue  
    Check to see if README.MD on GitHub has been updated via web browser instead of the script, download that instead.
