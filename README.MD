...
## Updates  
    Added a check for the newest README.MD. Now the user can edit the README.MD on GitHub through a web browser as well as locally through a text editor and the script will synchronize the file. 
